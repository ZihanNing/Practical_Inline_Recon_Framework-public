function handle_connection_background_sense_exterREF(Recon_ID)
    
    if nargin < 1 || isempty(Recon_ID); Recon_ID='SENSE_exterREF';end % modify this if needed
    ...
    try
        ...
        rec=InlineReconPipeline_exterREF(twix_like);
