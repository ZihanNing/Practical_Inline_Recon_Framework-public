function visMotion(rec,voxSiz,t,pau,folderName,fileName,yl,xl,op,numFig,titleName)
...
if nargin<8;xl=[];end
if nargin<9;op=[];end
if nargin<10;numFig=[];end
if nargin<11;titleName='';end
...
if ~strcmp(titleName,''); title(titleName,'Interpreter','latex','Color',[1 1 1],'FontSize',FontSizeA+ModLab);end
if pau==1;pause;end
