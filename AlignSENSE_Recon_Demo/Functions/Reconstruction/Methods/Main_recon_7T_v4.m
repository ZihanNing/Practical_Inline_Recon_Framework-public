...
study = 3;
if study ==2
    studies_20191023_DISORDER_Lucilio; addpath(genpath('/home/ybr19/Data/2019-10-23_DISORDER_Lucilio'))
    % Select studies to reconstruction
    idPath = 5;
    idFile = [1]; % 4 is the alternating continuous motion (fig 5 in DISORDER7T.pdf)
...
idB1=idRef;
idB0= idRef;%1*ones(1,length(idFile));
...
%% PROCESS DATA 
%TO CHANGE -- MAKE LIST UNIQUES HERE
...
%         rec = prepareRec(fileAcq, fileRef,fileB1,fileB0);
%         
%     end
% end
