...
function [pathIn, fileList,       refList,       refBList,      B0List,       B1List,...
                  fileListUnique, refListUnique, refBListUnique, B0ListUnique, B1ListUnique, isPTListUnique] =  extractStudies(pathIn, fileIn, refIn, refBIn, B0In, B1In,...
                                                                                               idPath, idFile, idRef, idB0, idB1, isPT)
