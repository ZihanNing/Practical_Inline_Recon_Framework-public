...
function [] = handle_connection_sense_exterREF(connection)
...
%     save('radial_test_bucket.mat','connection','bucketData','noiseData','-v7.3')
    ...
    Recon_ID = 'SENSE_exterREF'; % the configurations of each research ID is set within Framework_config.xml, including saved path, related bash, etc
