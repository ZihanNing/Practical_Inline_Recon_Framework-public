function [result, res, TE, shifts_TE1, shifts] = methods_recon_inline(twix, Tro, TE1only, shift, shift_echoes, shift_in, shift_in_TE1, shift_img)
    %===========================================================
    ...
    if contains(measDat.hdr.Dicom.SoftwareVersions, 'XA60') % new XA60 header  
        ...
        numEchoes = floor((size(data,1)-MTX)/(2*MTX)); % nr refocused echoes, i.e. half-spoke is echo 0
    else
